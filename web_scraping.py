...
search_bar = browser.find_element_by_xpath(search_bar_xpath)[0]  # find_by_xpath returns a list, so index 0
...
search_results = browser.find_element_by_xpath(search_results_xpath)  # returns list of link elements
