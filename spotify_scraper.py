...
#from spotipy import OAuth   #Client


#auth.request_client_credentials('22682913282348ebba55c9bf00605717', '0c9d7af6b9ca4522b51811425e71a14e')

#client = Client(auth)
# Get the username from terminal
username = sys.argv[1]
scope = 'user-read-private user-read-playback-state user-modify-playback-state'
#User ID: 22qf6mgm75pqn2zjyk2l6tsyi?si=oYVcBhXySLCUDBngCiDG1g
...
track = spotifyObject.current_user()
